  ...
  return (
    <div className="card">
      ...
      <div className="card-body">
        ...
        className="form-label text-white">Email
        </label>
          <input
          type="text"
          ...
          placeholder="name@example.com"
            name='email'
          />
          <label htmlFor="formPasswordInput"
          className="form-label text-white">Password
          </label>
          <input
          type="password"
          className="form-control form-input"
          ...
          />
          <div
          className="d-grid gap-3 col-12 mx-auto">
          <button
          type="submit"
          className="btn btn-primary btn-lg btn-login ">Login
          </button>
          </div>
        </form>
        </section>
